	...
	update() {
		...
		if (this.needsUpdate) {
			...
			if(this.renderInfo){
				...
				ctx.strokeText(this.renderInfo.render.points + ' points', 10, 44);
				ctx.fillText(this.renderInfo.render.points + ' points', 10, 44);

				ctx.strokeText(this.renderInfo.render.lines + ' lines', 10, 56);
				ctx.fillText(this.renderInfo.render.lines + ' lines', 10, 56);

				ctx.strokeText(this.renderInfo.render.frame + ' frame', 10, 68);
				ctx.fillText(this.renderInfo.render.frame + ' frame', 10, 68);

				ctx.strokeText(this.renderInfo.memory.textures + ' textures', 10, 80);
				ctx.fillText(this.renderInfo.memory.textures + ' textures', 10, 80);

				ctx.strokeText(this.renderInfo.memory.geometries + ' geometries', 10, 92);
				ctx.fillText(this.renderInfo.memory.geometries + ' geometries', 10, 92);
			}
